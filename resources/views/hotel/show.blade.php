        ...
        @if(!is_null($hotel->law))
            <div class="modal-container">
                ...
                <div class="modal-content">
                    ...
                    <h5>事件類別：<span>{{ $hotel->law->event }}</sapn></h5>
                    <p>{{ $hotel->law->directions }}</p> 
                    <a href="{{ $hotel->law->url }}" target="_blank">判決書完整內容連結</a>
                                ...
                                <div class="col">
                                    <div class="rating-card">
						                <div class="text-center m-b-30">  <!-- ... 調整表格裡面的位置 ... -->
							                <h1 class="rating-number">{{ $hotel->star_rating }}<small>/5</small></h1>
							                <div class="rating-stars d-inline-block position-relative mr-2">
								                <img src="{{ asset('img/reviews/grey-star.svg') }}" alt="">
								                <div class="filled-star" style="width:{{ $hotel->rate_star_percent }}%"></div>  <!-- ... width可以調整星星占比 ... -->
							                </div>
							                <div class="text-muted">{{ number_format($hotel->reviews) }} review</div> <br>
							                <div class="container">  <!-- ... 按鈕 ... -->
								                <div class="row">
								    	            <div class="col-sm-12 d-flex justify-content-center">
								    	    	        <a class="btn btn-lg mb-2" target="_blank" href="{{ $hotel->reviews_url }}" alt="點擊查看更多評論"><span>More Review</span></a>
								    	            </div>
								                </div>
							                </div>
						                </div>
...
<script>
    ...
    window.test_2_sendMessage('{!! $hotel->ch_name !!}', dictData)
</script>
